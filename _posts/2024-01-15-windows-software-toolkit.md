...
| 工具 | 功能 | 链接 | 备注 |
|------|------|------|------|
| Git | 版本控制工具 | [开源](https://github.com/git/git) | - |
...
| 篡改猴 | 用户脚本管理 | [greasyfork](https://greasyfork.org/zh-CN) | Tampermonkey |
| Infinity | 自定义新标签页 | - | - |
| Awesome Screenshot | 截图录屏 | - | - |
| bilibili 下载助手 | B站视频下载 | - | - |
...
* 教程：[新型真●一键激活JetBrains全家桶方式，不需要手动下载任何文件(懒人福利)！idea/win/linux/mac](https://linux.do/t/topic/694120)
